...
const sheetName = "Bing_Updated";

const update = async function () {
  // await BigQuery.createTable('109156790', `${sheetName}_Cost_Data_Temp`,  schema) // create if non exists

  const queries =
    "DELETE FROM `comfort-keepers-2b659.109156790.Bing_Updated` WHERE TRUE;";

  await bigquery.createJob(queries);

  console.log(
    "Table comfort-keepers-2b659.109156790.Bing_Cost_Data_Temp emptied."
  );
